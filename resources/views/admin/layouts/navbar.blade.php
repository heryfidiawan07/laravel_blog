...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
			<a href="{{ url('/') }}" target="_blank" class="nav-link text-gray-600">Visit Websites</a>
		</li>
		...
		<li class="nav-item dropdown no-arrow">
			<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				@if (is_null(Auth::user()->img))
                	<img src="{{ asset('parts/user.jpg') }}" class="rounded-circle" width="25">
                @else
                	<img src="{{ asset('storage/user/'.Auth::user()->img) }}" class="rounded-circle" width="25">
                @endif
			</a>
